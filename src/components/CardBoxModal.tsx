import { mdiAccount, mdiClose, mdiMail } from '@mdi/js'
...
const CardBoxEditModal = ({
 ...
 /*  const footer = (
    <BaseButtons>
      <BaseButton label={buttonLabel} type="submit" color={buttonColor} onClick={()=>{}} />
      {!!onCancel && <BaseButton label="Cancel" color={buttonColor} outline onClick={onCancel} />}
    </BaseButtons>
  ) */
